...
SECTION "Ruins tileset", ROMX, ALIGN[4]

BeachTileset::
	db 3
	full_ptr OverworldTilesetTiles0
	db 15
	full_ptr BeachHouseTiles
	db 6
	full_ptr RockTilesetTiles
	db 1
	full_ptr WaterFrames
	db 2
	full_ptr BeachBridgeTiles
	db 3
	full_ptr SignTilesetTiles
	db 1
	full_ptr FlowerFrames
	db 18
	full_ptr OverworldTilesetTiles2
	db 28
	full_ptr BeachDoorFrames
	db 2
	full_ptr BeachSandTiles
	db 0
